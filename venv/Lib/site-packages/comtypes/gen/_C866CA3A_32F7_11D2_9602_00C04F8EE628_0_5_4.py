...
__all__ = [
    'SPSMF_SAPI_PROPERTIES', 'ISpeechPhraseRule', 'SpLexicon',
    'eLEXTYPE_RESERVED7', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SGRClear', 'DISPID_SOTRemoveStorageFileName',
    'SPEI_SENTENCE_BOUNDARY', 'SPAS_RUN', 'DISPID_SGRSTPropertyName',
    'SPAO_RETAIN_AUDIO', 'SAFTCCITT_uLaw_11kHzMono',
    'SpeechEngineConfidence', 'DISPID_SVVoice', 'DISPID_SMSAMMHandle',
    'DISPID_SAStatus', 'SPEI_MAX_SR', 'SpFileStream',
    'SPBOOKMARKOPTIONS', 'DISPID_SASCurrentSeekPosition',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SLWPronunciations',
    'ISpRecoContext2', 'SAFT48kHz8BitMono',
    'DISPIDSPTSI_SelectionOffset', 'SRAORetainAudio',
    'SAFT12kHz16BitMono', 'DISPID_SpeechRecoResultTimes',
    'eLEXTYPE_RESERVED9', 'DISPID_SPRNumberOfElements',
    'ISpeechMMSysAudio', 'DISPID_SVStatus', 'SPRST_INACTIVE',
    'eLEXTYPE_PRIVATE7', 'SPSMF_UPS', 'SLTUser',
    'DISPID_SPIGrammarId', 'DISPID_SOTId', 'DISPID_SRIsUISupported',
    'SpeechEngineProperties', 'DISPID_SDKGetlongValue',
    'SAFTTrueSpeech_8kHz1BitMono', 'ISpeechGrammarRules',
    'DISPID_SPCIdToPhone', 'DISPID_SPAsCount', 'ISpStream',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SDKDeleteValue',
    'DISPID_SVGetVoices', 'DISPID_SPCLangId', 'SDKLCurrentUser',
    'DISPID_SRCRetainedAudioFormat', 'SPSLMA', 'ISpeechRecoResult',
    'DISPID_SVEPhoneme', 'SpMMAudioOut', 'DISPID_SOTCategory',
    'WAVEFORMATEX', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SpeechLexicon', 'ISpeechRecoResult2', 'SP_VISEME_18',
    'DISPID_SASCurrentDevicePosition', 'SDKLLocalMachine',
    'SpeechStreamSeekPositionType', 'Speech_StreamPos_Asap',
    'SFTSREngine', 'SPTEXTSELECTIONINFO', 'SBOPause',
    'SAFT11kHz16BitMono', 'DISPID_SVResume', 'DISPID_SOTs_NewEnum',
    'SPGS_EXCLUSIVE', 'SPEI_TTS_BOOKMARK', 'SRTExtendableParse',
    'ISpeechAudioStatus', 'DISPID_SVEAudioLevel', 'SPSModifier',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SPRText',
    'SpeechVoiceSkipTypeSentence', 'SDTDisplayText',
    'ISpNotifyTranslator', 'SPEI_FALSE_RECOGNITION', 'SPEI_RESERVED6',
    'SPSInterjection', 'SP_VISEME_11', 'SPEI_SR_BOOKMARK',
    'DISPID_SpeechAudioFormat', 'DISPID_SOTMatchesAttributes',
    'SLOStatic', 'DISPID_SPRsItem', 'DISPID_SPPParent',
    'DISPID_SPIGetText', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SGRAddState', 'DISPID_SRCVoice', 'SGSEnabled',
    'DISPID_SVIsUISupported', 'SpNotifyTranslator', 'SP_VISEME_15',
    'SPSSuppressWord', 'ISpRecoGrammar', 'SPGS_DISABLED',
    'SAFTADPCM_11kHzMono', 'SP_VISEME_17', 'SPSERIALIZEDRESULT',
    'SpeechVoiceEvents', 'SAFT22kHz8BitStereo', 'SPPS_Noncontent',
    'SVP_1', 'SPEI_MIN_TTS', 'eLEXTYPE_PRIVATE9', 'DISPID_SASState',
    'SVSFPersistXML', 'SpeechDisplayAttributes',
    'SAFT32kHz16BitStereo', 'DISPID_SPEAudioTimeOffset',
    'SPSTREAMFORMATTYPE', 'SPEI_RESERVED2', 'SREStreamStart',
    'ISpeechPhoneConverter', 'SpeechAllElements',
    'SWPUnknownWordPronounceable', 'DISPID_SOTIsUISupported',
    'eLEXTYPE_VENDORLEXICON',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SVP_8',
    'eLEXTYPE_PRIVATE1', 'ISpProperties', 'SPINTERFERENCE_NOISE',
    'SP_VISEME_6', 'SAFTCCITT_uLaw_22kHzMono', 'SGRSTTWildcard',
    'DISPID_SLPsCount', 'SASRun', 'DISPID_SRStatus', 'SPCATEGORYTYPE',
    'eLEXTYPE_PRIVATE19', 'SAFTADPCM_22kHzMono',
    'DISPID_SpeechXMLRecoResult', 'SVSFNLPMask',
    'ISpeechRecognizerStatus', 'DISPID_SRAudioInputStream',
    'SpeechPropertyNormalConfidenceThreshold', 'SPWT_PRONUNCIATION',
    'DISPID_SVEVoiceChange', 'DISPID_SVEBookmark', 'SPVPRI_ALERT',
    'ISpLexicon', 'SGRSTTWord', 'DISPID_SOTRemove', 'SPLEXICONTYPE',
    'ISpPhoneticAlphabetSelection', 'IEnumString',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SAEventHandle',
    'SPSEMANTICFORMAT', 'ISpEventSource',
    'SpeechPropertyResponseSpeed', 'SGDisplay', 'SPINTERFERENCE_NONE',
    'IInternetSecurityMgrSite', 'SVP_4', 'SPVPRI_NORMAL',
    'SpSharedRecognizer', 'STCInprocServer', 'SP_VISEME_12',
    'DISPID_SOTSetId', 'ISpPhrase', 'STCInprocHandler',
    'DISPID_SRGSetWordSequenceData',
    'ISpeechTextSelectionInformation', 'DISPID_SVSpeak',
    'DISPID_SOTsCount', 'SECFEmulateResult',
    'DISPID_SASFreeBufferSpace', 'ISpeechLexiconWords',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SpeechFileStream',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SRCEHypothesis',
    'DISPID_SRCEEnginePrivate', 'DISPID_SGRName',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SLAddPronunciationByPhoneIds', 'SGPronounciation',
    'DISPID_SLGenerationId', 'SPCT_DICTATION', 'SRTStandard',
    'DISPID_SRGCmdLoadFromObject', 'SBONone', 'ISpVoice',
    'ISpeechDataKey', 'DISPID_SPIRule', 'DISPID_SBSSeek',
    'SPADAPTATIONRELEVANCE', 'STSF_CommonAppData',
    'DISPID_SPEActualConfidence', 'DISPID_SRRPhraseInfo',
    'SGDSInactive', 'SPPS_SuppressWord', 'eLEXTYPE_PRIVATE11',
    'DISPID_SpeechRecognizer', 'DISPID_SPRuleChildren',
    'DISPID_SWFEExtraData', 'DISPID_SRRTimes', 'DISPID_SRGRules',
    'SPEI_SR_AUDIO_LEVEL', 'SVP_6', 'SVP_11', 'STCLocalServer',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SAFT44kHz16BitStereo',
    'DISPID_SLPSymbolic', 'SPRST_ACTIVE_ALWAYS', 'DISPID_SGRsCount',
    'DISPID_SDKSetLongValue', 'DISPID_SPIAudioSizeBytes',
    'DISPIDSPTSI', 'DISPID_SRGCommit', 'SGRSTTTextBuffer',
    'eLEXTYPE_PRIVATE18', 'DISPID_SRSAudioStatus',
    'SSFMOpenReadWrite', 'DISPID_SDKGetBinaryValue',
    'SpeechAudioFormatGUIDText', 'SAFT44kHz16BitMono',
    'SAFTCCITT_ALaw_22kHzMono', 'SDTLexicalForm', 'SITooFast',
    'SVP_16', 'DISPID_SABIMinNotification', 'SPPS_LMA',
    'SPPHRASEREPLACEMENT', 'SPSVerb', 'DISPID_SpeechPhraseElements',
    'eLEXTYPE_USER', 'DISPID_SDKSetStringValue', 'SPVPRIORITY',
    'DISPID_SRGDictationUnload',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SGSExclusive',
    ...
    'DISPID_SPERetainedSizeBytes', 'IStream', 'SPXRO_Alternates_SML',
    'SVEWordBoundary', 'SPPS_Unknown', 'SREStateChange',
    'DISPID_SRSetPropertyString', 'eLEXTYPE_PRIVATE12', 'LONG_PTR',
    'SpSharedRecoContext', 'DISPID_SPIReplacements', 'SPRS_INACTIVE',
    'SPCT_SUB_COMMAND', 'SpeechTokenKeyAttributes',
    'SpeechUserTraining', 'SPAO_NONE', 'SPFILEMODE',
    'ISpeechAudioFormat', 'SpObjectTokenCategory', 'SpeechWordType',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SMSSetData',
    'DISPID_SVSPhonemeId', 'ISpGrammarBuilder',
    'DISPID_SPRFirstElement', 'SPEI_TTS_PRIVATE', 'SPEI_RESERVED1',
    'SPWORDPRONOUNCEABLE', 'DISPID_SDKEnumKeys', 'SPRULESTATE',
    'DISPID_SRDisplayUI', 'SAFT8kHz8BitMono',
    '_ISpeechRecoContextEvents', 'ISpeechLexiconWord',
    'SpWaveFormatEx', 'SPPARTOFSPEECH', 'DISPID_SOTCId',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SGRSTPropertyId',
    'DISPID_SGRSTsCount', 'ISpeechCustomStream',
    'DISPID_SWFEBlockAlign', 'SVP_10', 'DISPID_SRCEInterference',
    'SLODynamic', 'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SpCustomStream',
    'SVEPrivate', 'SpVoice', 'DISPID_SAVolume', 'SAFT8kHz16BitMono',
    '_RemotableHandle', 'IEnumSpObjectTokens', 'DISPID_SPILanguageId',
    'DISPID_SWFESamplesPerSec', 'SpeechAudioState',
    'DISPID_SRRecognizer', 'STSF_FlagCreate',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpeechPhraseReplacements',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SVP_9',
    'ISpeechMemoryStream', 'DISPID_SRRAudio',
    'ISpObjectTokenCategory', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SVAlertBoundary', 'SpPhoneticAlphabetConverter',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SFSClose',
    'DISPID_SLRemovePronunciation', 'DISPID_SpeechPhraseAlternate',
    'SDTAudio', 'ISpeechAudio', 'SpeechPropertyAdaptationOn',
    'SP_VISEME_19', 'SpeechGrammarTagUnlimitedDictation',
    ...
    'DISPID_SRSetPropertyNumber', 'SPRULE', 'SP_VISEME_1',
    'SPEI_PHONEME', 'SAFTCCITT_ALaw_22kHzStereo', 'SASPause',
    'SPVOICESTATUS', 'eLEXTYPE_PRIVATE13', 'SVEEndInputStream',
    'SpeechAudioFormatType', 'DISPID_SPRs_NewEnum',
    'SPRST_INACTIVE_WITH_PURGE', 'eWORDTYPE_DELETED',
    'DISPID_SpeechPhraseElement', 'DISPID_SPIGetDisplayAttributes',
    'SPWORD', 'DISPID_SRCEPhraseStart', 'SAFTCCITT_uLaw_8kHzStereo',
    'SVSFIsFilename', 'DISPID_SPRulesItem', 'ISpeechVoice',
    'eLEXTYPE_PRIVATE14', 'DISPID_SpeechRecoContext',
    'SpeechCategoryRecoProfiles', 'SRARoot', 'ISpMMSysAudio',
    'DISPID_SPEsItem', 'SWPKnownWordPronounceable',
    'SAFT32kHz16BitMono', 'SAFT48kHz16BitStereo',
    'SECFIgnoreKanaType', 'SPSUnknown', 'DISPID_SADefaultFormat',
    'DISPID_SRCVoicePurgeEvent', 'SPSHT_Unknown',
    'eLEXTYPE_LETTERTOSOUND', 'SREPrivate', 'SITooQuiet',
    'DISPID_SRGReset', 'DISPIDSPRG', 'SRSInactiveWithPurge',
    'DISPID_SLWType', 'eLEXTYPE_MORPHOLOGY', 'DISPID_SWFEChannels',
    'SPSFunction', 'SRADefaultToActive', 'DISPID_SpeechObjectToken',
    'SREHypothesis', 'SPWT_DISPLAY',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechCategoryAudioIn', 'SVSFlagsAsync', 'SINoise',
    'eLEXTYPE_PRIVATE10', 'SPEVENT', 'DISPID_SLPLangId',
    'SpeechRuleAttributes', 'SpeechAudioFormatGUIDWave',
    'DISPID_SBSRead', 'SGDSActiveUserDelimited', 'SpeechAudioVolume',
    'ISpeechLexiconPronunciation', 'DISPID_SVRate', 'DISPID_SPPsItem',
    'SAFT24kHz8BitStereo', 'DISPID_SVSRunningState',
    'ISpeechWaveFormatEx', 'SPINTERFERENCE_TOOQUIET', 'SPAS_STOP',
    'SVP_7', 'SpMemoryStream', 'SP_VISEME_10', 'SAFT48kHz16BitMono',
    'Speech_Max_Pron_Length', 'ISpPhoneticAlphabetConverter',
    'SDKLCurrentConfig', 'SDTPronunciation', 'SITooLoud',
    'DISPID_SpeechAudio', 'SDTAll', 'SASClosed', 'DISPID_SLPsItem',
    'SDTAlternates', 'Speech_Default_Weight', 'SVEPhoneme',
    'SpeechInterference', 'SPAUDIOSTATE', 'DISPID_SMSALineId',
    'SPAS_PAUSE', 'SPPS_NotOverriden', 'SVSFVoiceMask',
    'DISPID_SpeechGrammarRule', 'DISPID_SPAs_NewEnum',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SRProfile',
    'SpeechRecognizerState', 'SAFT12kHz8BitMono',
    'SAFT22kHz16BitMono', 'SVEVoiceChange', 'SPINTERFERENCE_TOOSLOW',
    'ISpeechPhraseElement', 'Speech_StreamPos_RealTime', 'SVP_18',
    'DISPID_SRRDiscardResultInfo', 'SpStream', 'eLEXTYPE_RESERVED10',
    'DISPID_SRCRecognizer', 'SP_VISEME_8', 'SPRECOGNIZERSTATUS',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SGRs_NewEnum', 'SVPOver',
    'DISPID_SPPFirstElement', 'SVP_12', 'ISpAudio', 'SPPS_Verb',
    'DISPID_SRIsShared', 'DISPID_SDKEnumValues', 'ISpRecognizer3',
    ...
    'ISpeechAudioBufferInfo', 'DISPID_SAFType',
    'DISPID_SRGCmdSetRuleIdState', 'SREAdaptation',
    'SAFT12kHz16BitStereo', 'SAFT22kHz8BitMono',
    'DISPID_SRGCmdLoadFromMemory', 'SAFTADPCM_8kHzMono',
    'SRESoundEnd', 'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SGRSTWeight',
    'SAFTNoAssignedFormat', 'DISPID_SRGetPropertyNumber',
    'SAFTNonStandardFormat', 'DISPID_SOTCreateInstance',
    'SPRECORESULTTIMES', 'SRAImport', 'DISPID_SVSInputWordPosition',
    'SAFT11kHz8BitMono', 'SRSInactive', 'SPCT_SUB_DICTATION',
    'SPPHRASEPROPERTY', 'SVP_21', 'DISPID_SLPType',
    'DISPID_SRSCurrentStreamPosition', 'SpPhoneConverter',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFT16kHz8BitMono',
    'SPWORDTYPE', 'eLEXTYPE_PRIVATE3', 'DISPID_SPISaveToMemory',
    'SPDKL_CurrentConfig', 'SRATopLevel',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SGRSTPropertyValue',
    'SAFTGSM610_22kHzMono', 'DISPID_SpeechRecoResult2',
    'DISPID_SPRsCount', 'SPPS_Modifier', 'DISPID_SVEWord',
    'DISPID_SPIAudioSizeTime', 'SPSNoun', 'SPAS_CLOSED',
    'SPEI_SOUND_START', 'SPGRAMMARSTATE', 'DISPID_SABufferNotifySize',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SPPEngineConfidence', 'SAFT8kHz8BitStereo',
    'DISPID_SRGCmdSetRuleState', 'SPPHRASERULE', 'ISpRecognizer',
    'DISPID_SRCreateRecoContext', 'DISPID_SPAPhraseInfo',
    'SAFTCCITT_ALaw_11kHzStereo', 'SpeechRecognitionType',
    'ISpRecoContext', 'DISPID_SRGId', 'DISPID_SRGCmdLoadFromResource',
    'ISpStreamFormatConverter', 'eLEXTYPE_PRIVATE17',
    'DISPID_SGRSTNextState', 'SVP_2', 'DISPID_SpeechMMSysAudio',
    'SREPropertyNumChange', 'SPDKL_LocalMachine',
    'ISpeechPhraseElements', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPEI_END_SR_STREAM', 'SRCS_Enabled',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPEI_ADAPTATION',
    'SPFM_OPEN_READWRITE', 'SPEI_RESERVED3', 'SECHighConfidence',
    'DISPID_SLWsItem', 'DISPID_SLWLangId', 'SVSFIsXML', 'SPWORDLIST',
    'SECFNoSpecialChars', 'SRTEmulated', 'ISpeechGrammarRuleState',
    ...
    'DISPID_SPRulesCount', 'DISPID_SVSInputSentenceLength',
    'DISPID_SRCCmdMaxAlternates', 'SpeechWordPronounceable',
    'SAFTGSM610_44kHzMono', 'eLEXTYPE_PRIVATE16',
    'SpeechRegistryLocalMachineRoot', 'SSTTTextBuffer',
    'DISPID_SRRTLength', 'SSFMOpenForRead', 'DISPID_SRSClsidEngine',
    'SPPHRASE', 'SASStop', 'SpeechRunState', 'DISPID_SCSBaseStream',
    'ISpResourceManager', 'SpeechDataKeyLocation',
    'DISPID_SRGDictationLoad', 'SPEVENTENUM', 'DISPID_SBSWrite',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SGRId',
    'SPPROPERTYINFO', 'SAFT11kHz8BitStereo', 'DISPID_SRRSpeakAudio',
    'DISPID_SLPs_NewEnum', 'SDA_Consume_Leading_Spaces',
    'DISPID_SpeechObjectTokens', 'ISpeechPhraseInfoBuilder',
    'SPEI_RESERVED5', 'DISPID_SPPChildren', 'ISpPhraseAlt',
    'DISPID_SOTCDefault', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRCRetainedAudio', 'ISpObjectToken', 'DISPID_SVEViseme',
    'SpeechTokenContext', 'DISPID_SRCEStartStream',
    'DISPID_SRCEAdaptation', 'SPWORDPRONUNCIATION',
    'DISPID_SLPPhoneIds', 'ISpeechResourceLoader',
    'ISpeechObjectToken', 'DISPID_SVGetProfiles', 'SPSNotOverriden',
    'SPWF_INPUT', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SVP_17',
    'DISPID_SPCPhoneToId', 'SpeechEmulationCompareFlags',
    'SpeechGrammarState', 'DISPID_SRCResume',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SpeechVoice', 'SVEBookmark',
    'DISPID_SVEStreamEnd', 'SAFT11kHz16BitStereo',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SPIProperties', 'eLEXTYPE_PRIVATE2', 'SVP_5',
    'SAFTCCITT_uLaw_8kHzMono', 'SVP_0', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPBO_NONE', 'STSF_AppData', 'SAFTGSM610_8kHzMono',
    'DISPID_SPEDisplayText', 'SpNullPhoneConverter', 'DISPID_SLWWord',
    'eLEXTYPE_APP', 'DISPID_SPAsItem', 'ISpSerializeState',
    'DISPID_SpeechPhraseRules', 'DISPID_SDKOpenKey',
    'SpInProcRecoContext', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPWT_LEXICAL', 'ISpeechRecoResultTimes', 'ISpDataKey',
    'SPCT_COMMAND', 'SAFT22kHz16BitStereo', 'eLEXTYPE_PRIVATE6',
    'DISPID_SPIStartTime', 'SpeechCategoryVoices', 'DISPID_SGRSTRule',
    'SRESoundStart', 'SpeechGrammarRuleStateTransitionType',
    'SECFIgnoreWidth', 'SGRSTTEpsilon', 'ISpeechBaseStream',
    'DISPID_SLPPartOfSpeech', 'SPEI_REQUEST_UI', 'SPAR_Low',
    'STSF_LocalAppData', 'SGLexicalNoSpecialChars', 'ISpRecognizer2',
    'SREPropertyStringChange', 'DISPID_SPEAudioSizeTime',
    'SAFT48kHz8BitStereo', 'ISpeechLexiconPronunciations',
    'SP_VISEME_4', 'ISpeechVoiceStatus', 'tagSPTEXTSELECTIONINFO',
    'SVSFParseSapi', 'ISpNotifySink',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SVSInputSentencePosition', 'SpeechGrammarTagDictation',
    'SP_VISEME_21', 'SRSEIsSpeaking', 'SAFT32kHz8BitStereo',
    '_ISpeechVoiceEvents', 'SPVPRI_OVER', 'ISpeechObjectTokens',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SLGetWords',
    'SPEI_START_INPUT_STREAM', 'SPCT_SLEEP', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SPEAudioSizeBytes', 'SPSHORTCUTTYPE',
    'SpeechDictationTopicSpelling', 'SPXMLRESULTOPTIONS',
    'DISPID_SGRsFindRule', 'SpeechRecoEvents', 'SP_VISEME_0',
    'SpeechCategoryAppLexicons', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SOTGetAttribute', 'SREPhraseStart',
    'DISPID_SRCCreateGrammar', 'DISPID_SGRAddResource',
    'SPEI_INTERFERENCE', 'DISPID_SRGetFormat',
    'DISPID_SRCEventInterests', 'SPEI_HYPOTHESIS', 'SP_VISEME_13',
    'SSTTDictation', 'SRTReSent', 'ISpRecoResult', 'ISpEventSink',
    'SREAudioLevel', 'SPBO_AHEAD', 'SRCS_Disabled',
    'SpeechTokenKeyFiles', 'DISPID_SASNonBlockingIO',
    'SPEI_PHRASE_START', 'DISPID_SpeechLexiconProns',
    'ISpNotifySource', 'SpeechCategoryAudioOut', 'DISPID_SPPName',
    'DISPID_SLAddPronunciation', 'DISPID_SpeechMemoryStream',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SRCESoundStart',
    'SPPS_RESERVED2', 'SpeechRuleState', 'DISPID_SFSOpen',
    'DISPID_SWFEFormatTag', 'ISpeechFileStream',
    'DISPID_SRGDictationSetState', 'SVP_15', 'SpeechGrammarWordType',
    'STCAll', 'SPEI_SR_PRIVATE', 'DISPID_SPEsCount',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SVSLastResult',
    'SP_VISEME_3', 'DISPID_SpeechRecoResult', 'DISPID_SPPValue',
    'SpeechVoicePriority', 'DISPID_SPEDisplayAttributes',
    'SAFTCCITT_uLaw_44kHzMono', 'SpeechPropertyResourceUsage',
    'SP_VISEME_20', 'SPPS_RESERVED3', 'DISPID_SRGState',
    'SP_VISEME_16', 'SAFT8kHz16BitStereo',
    'DISPID_SREmulateRecognition', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SGRSAddWordTransition', 'SpeechCategoryRecognizers',
    'SpeechVisemeType', 'SRTSMLTimeout', 'DISPID_SRCEBookmark',
    'SpeechLexiconType', 'DISPID_SRRGetXMLResult', 'SPPS_Function',
    'SpeechMicTraining', 'eLEXTYPE_RESERVED6', 'SRERequestUI',
    'SAFTDefault', 'SVP_20', 'DISPID_SpeechLexiconWord',
    'DISPID_SOTGetStorageFileName', 'DISPID_SAFGuid',
    'SPINTERFERENCE_NOSIGNAL', 'SPRECOCONTEXTSTATUS',
    'DISPID_SpeechPhraseProperty', '__MIDL_IWinTypes_0009',
    'SRERecoOtherContext', 'SPRECOSTATE', 'SVEViseme',
    'SpCompressedLexicon', 'SDKLDefaultLocation', 'SRADynamic',
    'DISPID_SRCCreateResultFromMemory', 'SGDSActive', 'SPPS_Noun',
    'SVF_None', 'SpeechSpecialTransitionType', 'SPAUDIOOPTIONS',
    'SpeechTokenValueCLSID', 'SPRS_ACTIVE', 'DISPID_SRRTStreamTime',
    'SVF_Emphasis', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SPIEngineId', 'SVEAudioLevel', 'DISPID_SpeechAudioStatus',
    'DISPID_SpeechPhraseProperties', 'SWTDeleted',
    'Speech_Max_Word_Length', 'SPINTERFERENCE',
    'ISpeechPhraseAlternates', 'SpeechPropertyComplexResponseSpeed',
    'SpStreamFormatConverter', 'DISPID_SAFSetWaveFormatEx',
    'SpeechFormatType', 'DISPID_SpeechPhoneConverter',
    'DISPID_SPARecoResult', 'DISPID_SRRRecoContext',
    'SVSFNLPSpeakPunc', 'SDTRule', 'SpTextSelectionInformation',
    'SpeechDiscardType', 'SVESentenceBoundary', 'SP_VISEME_5',
    'SVP_13', 'DISPID_SOTGetDescription', 'SVSFPurgeBeforeSpeak',
    'SGDSActiveWithAutoPause', 'SRAInterpreter', 'DISPID_SASetState',
    '_SPAUDIOSTATE', 'DISPID_SpeechVoiceEvent', 'eLEXTYPE_PRIVATE5',
    'SECNormalConfidence', 'DISPID_SRCRequestedUIType',
    'SpeechCategoryPhoneConverters', 'SINoSignal',
    'SDA_No_Trailing_Space', 'SAFTCCITT_ALaw_8kHzStereo',
    'eWORDTYPE_ADDED', 'SPRST_NUM_STATES', 'SAFT24kHz8BitMono',
    'SVP_19', 'SRSActiveAlways', 'SAFTADPCM_11kHzStereo',
    'DISPID_SRCERequestUI', 'SPLO_STATIC',
    'DISPID_SpeechRecoContextEvents', 'SpeechVoiceSpeakFlags',
    'SAFT32kHz8BitMono', 'DISPID_SGRsAdd', 'ISpeechRecoGrammar',
    'SAFTADPCM_22kHzStereo', 'SAFT16kHz16BitMono',
    'DISPID_SVSVisemeId', 'ISpXMLRecoResult', 'SECFDefault',
    'DISPID_SGRsItem', 'SPFM_CREATE', 'SREInterference',
    'DISPID_SRCESoundEnd', 'DISPID_SABufferInfo', 'SDTReplacement',
    'ISpPhoneConverter', 'SGRSTTDictation', 'SP_VISEME_9',
    'eLEXTYPE_PRIVATE20', 'DISPID_SDKGetStringValue',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPWAVEFORMATTYPE',
    'SPEI_SOUND_END', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SRCERecognition', 'SPPS_RESERVED1',
    'DISPID_SRRTTickCount', 'DISPID_SRGRecoContext',
    'DISPID_SRGSetTextSelection', 'SVSFDefault', 'SSFMCreate',
    'SPBO_TIME_UNITS', 'SPFM_NUM_MODES',
    ...
    'SpAudioFormat', 'DISPID_SRState', 'DISPID_SGRSTs_NewEnum',
    'SpShortcut', 'SECFIgnoreCase', 'eLEXTYPE_RESERVED4',
    'IInternetSecurityManager', 'SpResourceManager',
    'DISPID_SRRGetXMLErrorInfo', 'SPSERIALIZEDPHRASE',
    'DISPID_SBSFormat', 'SRSActive', 'DISPID_SPACommit',
    'eLEXTYPE_PRIVATE4', 'SpeechAudioProperties', 'SPAR_Medium',
    'ISpeechPhraseInfo', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRRAudioFormat', 'ISpStreamFormat', 'ISpShortcut',
    'SVSFUnusedFlags', 'SVEStartInputStream', 'SPEI_VISEME',
    'SPEI_END_INPUT_STREAM', 'DISPID_SLGetGenerationChange',
    'DISPID_SVEStreamStart', 'SpeechRegistryUserRoot',
    'DISPID_SDKCreateKey', 'SP_VISEME_2', 'DISPID_SABIBufferSize',
    'SPSHORTCUTPAIRLIST', 'DISPID_SPRDisplayAttributes',
    'DISPID_SVSpeakStream', 'SPWORDPRONUNCIATIONLIST', 'UINT_PTR',
    'DISPID_SPIElements', 'SAFT12kHz8BitStereo',
    'SPEI_PROPERTY_STRING_CHANGE', 'SVSFParseMask',
    'DISPID_SVSpeakCompleteEvent', 'ISpeechPhraseRules',
    'DISPID_SVSyncronousSpeakTimeout', 'SGLexical',
    'DISPID_SPRuleParent', 'SREStreamEnd', 'DISPID_SRCEEndStream',
    'ISpeechLexicon', 'DISPID_SRCEAudioLevel', 'SPPHRASEELEMENT',
    'DISPID_SVSLastBookmarkId', 'DISPID_SOTCGetDataKey',
    'SPGS_ENABLED', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SVVolume', 'SPLO_DYNAMIC', 'DISPID_SOTsItem',
    'DISPID_SpeechBaseStream', 'SREAllEvents',
    'SAFTExtendedAudioFormat', 'eLEXTYPE_PRIVATE15',
    'SpInprocRecognizer', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SGRSTText', 'DISPID_SPEs_NewEnum', 'ISpeechGrammarRule',
    'SDA_One_Trailing_Space', 'SRTAutopause',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SAFGetWaveFormatEx', 'SPDKL_CurrentUser',
    'SWPUnknownWordUnpronounceable', 'SDTProperty', 'SPAUDIOSTATUS',
    'DISPID_SpeechObjectTokenCategory', 'SDA_Two_Trailing_Spaces',
    'SpMMAudioEnum', 'SAFTADPCM_8kHzStereo', 'SVSFIsNotXML',
    ...
    'ISpeechRecognizer', 'SFTInput', 'DISPID_SPPs_NewEnum',
    'DISPID_SpeechPhraseInfo', 'DISPID_SMSGetData', 'SGSDisabled',
    'DISPID_SRAudioInput', 'DISPID_SPEEngineConfidence', 'SINone',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SVDisplayUI',
    'SSTTWildcard', 'DISPID_SPPId', 'DISPID_SpeechPhraseRule',
    'ISpeechPhraseReplacement', 'DISPID_SGRsCommit',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SDKDeleteKey',
    'DISPID_SPRules_NewEnum', 'DISPID_SpeechLexiconWords',
    'SPBO_PAUSE', 'DISPID_SRCAudioInInterferenceStatus', 'SWTAdded',
    'DISPID_SLGetPronunciations', 'DISPID_SVGetAudioOutputs',
    'SpeechStreamFileMode', 'SRAExport',
    'DISPID_SpeechAudioBufferInfo', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SPRuleConfidence', 'DISPID_SLWs_NewEnum',
    'ISpeechObjectTokenCategory', 'DISPID_SpeechGrammarRuleState',
    'tagSTATSTG', 'SRAONone', 'DISPID_SDKSetBinaryValue',
    'SPEI_VOICE_CHANGE', 'SPDKL_DefaultLocation', 'SVSFParseSsml',
    'SVEAllEvents', 'SpeechBookmarkOptions', 'SP_VISEME_14',
    'SpeechLoadOption', 'SpeechRecoProfileProperties',
    'DISPID_SVSkip', 'DISPID_SPRuleName', 'SPAUDIOBUFFERINFO',
    'SPSHT_OTHER', 'SpeechTokenIdUserLexicon', 'DISPID_SVPriority',
    'ISpRecoCategory', 'DISPID_SRCPause',
    'DISPID_SRCSetAdaptationData', 'DISPID_SpeechVoiceStatus',
    'SPSHT_NotOverriden', 'SPCS_ENABLED',
    'DISPID_SRSNumberOfActiveRules', 'SPRST_ACTIVE',
    'DISPID_SPRuleFirstElement', 'SGRSTTRule',
    'DISPID_SRGetRecognizers', 'SPPS_Interjection',
    'DISPID_SVEventInterests', 'SPEI_MIN_SR', 'SRSEDone',
    'SVF_Stressed', 'ISpRecoGrammar2', 'DISPID_SVGetAudioInputs',
    'SP_VISEME_7', 'SRERecognition', 'SPWF_SRENGINE',
    'SPEI_UNDEFINED', 'SAFTADPCM_44kHzMono', 'SPXRO_SML',
    ...
    'SpMMAudioIn', 'DISPID_SVAudioOutput',
    'DISPID_SRCEPropertyNumberChange', 'SpeechTokenKeyUI',
    'SPSHORTCUTPAIR', 'SpeechRecoContextState', 'SREBookmark',
    'SPEI_MAX_TTS', 'DISPID_SGRsDynamic', 'DISPID_SGRSTType',
    'SpeechPartOfSpeech', 'DISPID_SVSLastBookmark',
    'ISpeechXMLRecoResult', 'SpObjectToken', 'SPEI_RECO_STATE_CHANGE',
    'SPGRAMMARWORDTYPE', 'DISPID_SOTCEnumerateTokens',
    'SPCONTEXTSTATE', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SVP_3',
    'SPPS_RESERVED4', 'SpeechTokenShellFolder', 'ISpObjectWithToken',
    'SPCS_DISABLED', 'SpUnCompressedLexicon', 'SAFTGSM610_11kHzMono',
    'SVPNormal', 'SSSPTRelativeToEnd', 'SITooSlow', 'SPBINARYGRAMMAR',
    'DISPID_SVEEnginePrivate', 'SPEI_START_SR_STREAM',
    'SAFT16kHz8BitStereo', 'DISPID_SGRSTransitions',
    'SSSPTRelativeToStart', 'SVP_14', 'SPFM_OPEN_READONLY',
    'SPFM_CREATE_ALWAYS', 'SPEI_WORD_BOUNDARY', 'DISPID_SPRuleId',
    'ISpeechPhraseProperty', 'SPEI_RECOGNITION',
    'DISPID_SPIAudioStreamPosition', 'SPAR_High', 'DISPID_SGRSRule',
    'SPVISEMES', 'ISpeechPhraseProperties', 'eLEXTYPE_RESERVED8',
    'DISPID_SPAStartElementInResult', 'DISPID_SGRInitialState',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRRAlternates',
    'DISPID_SLWsCount', 'SLTApp', 'SpeechRetainedAudioOptions',
    'SAFTText', 'SPSEMANTICERRORINFO', 'SPAR_Unknown',
    'SpeechGrammarTagWildcard', 'SPEVENTSOURCEINFO',
    'SECLowConfidence', 'DISPID_SRRSaveToMemory',
    'ISpeechRecoContext', 'eLEXTYPE_PRIVATE8', 'SPDATAKEYLOCATION',
    'SREFalseRecognition', 'DISPID_SGRsCommitAndSave',
    'SPLOADOPTIONS', 'tagSPPROPERTYINFO', 'DISPID_SOTDisplayUI',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SpeechCustomStream',
    'DISPID_SOTDataKey', 'SVPAlert', 'SAFT24kHz16BitMono',
    'SAFT44kHz8BitStereo'
]
